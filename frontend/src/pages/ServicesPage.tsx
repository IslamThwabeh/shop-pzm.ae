  ...
  return (
    <div className="space-y-12">
      ...
      <section className="text-center">
        ...
        <h1 className="mt-3 text-3xl md:text-4xl font-bold text-gray-900">Our Services</h1>
        <p className="mt-3 text-brandTextMedium max-w-xl mx-auto">
      ...
      <section id="appointment" className="rounded-[28px] border border-brandBorder bg-[linear-gradient(180deg,#f0f7ff_0%,#e8f4fd_100%)] p-6 shadow-sm md:p-8">
        <div className="grid grid-cols-1 gap-6 lg:grid-cols-[1.1fr,0.9fr] lg:items-start">
          <div>
            ...
            <h2 className="mt-3 text-3xl font-bold text-slate-950">Need help choosing the right service?</h2>
