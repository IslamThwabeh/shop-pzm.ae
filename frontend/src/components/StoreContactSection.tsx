      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="mx-auto max-w-6xl">
          <div className="max-w-3xl">
            <p className="text-sm font-semibold uppercase tracking-[0.18em] text-primary">{t('contactSectionEyebrow')}</p>
            <h2 className="mt-3 text-[1.9rem] font-bold tracking-tight text-slate-950 md:text-[2.25rem]">{t('contactSectionHeading')}</h2>
          ...
          <div className="mt-8 grid gap-4 md:grid-cols-3">
            ...
            >
              ...
              <p className="mt-4 text-sm font-semibold uppercase tracking-[0.16em] text-brandTextMedium">{t('contactCardCallLabel')}</p>
            ...
            >
              ...
              <p className="mt-4 text-sm font-semibold uppercase tracking-[0.16em] text-brandTextMedium">{t('contactCardWhatsappLabel')}</p>
              <p className="mt-2 text-lg font-bold text-slate-950">{t('contactCardWhatsappDesc')}</p>
            </a>
            ...
            >
              ...
              <p className="mt-4 text-sm font-semibold uppercase tracking-[0.16em] text-brandTextMedium">{t('contactCardVisitLabel')}</p>
              <p className="mt-2 text-lg font-bold text-slate-950">{t('contactCardVisitDesc')}</p>
              <p className="mt-1 text-sm text-brandTextMedium">{t('contactCardVisitSub')}</p>
            </a>
          </div>

          <div className="mt-8 grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            <div className="rounded-3xl border border-brandBorder bg-white p-6 shadow-sm md:p-8">
              <p className="text-sm font-semibold uppercase tracking-[0.18em] text-primary">{t('storeCardEyebrow')}</p>
              <h3 className="mt-3 text-3xl font-bold text-brandTextDark">{siteIdentity.name}</h3>
              <p className="mt-2 text-sm font-semibold uppercase tracking-[0.16em] text-brandTextMedium">{t('storeCardTagline')}</p>
